...
class TestSphereHandling:
    ...
    def test_multiple_spheres_are_added(self):
        ...
        results = zenolib.compute_zeno_single_frame(
            positions, radii,
            params_walk, params_interior, params_results
        )
    ...
    def test_sphere_locking_order(self):
        ...
        results1 = zenolib.compute_zeno_single_frame(
            positions, radii,
            params_walk_1, params_interior_1, params_results_1
        )
        ...
        results2 = zenolib.compute_zeno_single_frame(
            positions, radii,
            params_walk_2, params_interior_2, params_results_2
        )
        
        print(f"Second computation:")
