...
class TestZenoLibBindings:
    ...
    def test_compute_single_sphere(self):
        ...
        # Run computation
        result = zenolib.compute_zeno_single_frame(positions, radii, params_walk, params_interior, params_results)
    ...
    def test_invalid_input_shapes(self):
        ...
        with pytest.raises((ValueError, RuntimeError, TypeError)):
            zenolib.compute_zeno_single_frame(positions, radii, params_walk, params_interior, params_results)
...
class TestZenoWrapperIntegration:
    ...
    def simple_universe(self):
        ...
        u = make_Universe(extras=("masses", "radii", "types"), size=(10, 2, 1), n_frames=3)
        # Set some positions
    ...
    def test_wrapper_atom_selection(self, simple_universe):
        ...
        wrapper = ZenoWrapper(selected_atoms, type_radii=type_radii)
    ...
    def test_run_partial_trajectory(self, simple_universe):
        ...
        type_radii = {"X": 1.5}
        wrapper = ZenoWrapper(simple_universe.atoms, type_radii=type_radii, n_walks=5000, n_interior_samples=500)
...
class TestZenoWrapperEdgeCases:
    ...
    def test_single_atom(self):
        ...
        u = make_Universe(extras=("radii", "types"), size=(1, 1, 1), n_frames=1)
        u.atoms.radii = np.array([2.0])
        u.atoms.types = ["X"]
        u.trajectory[0].positions = np.array([[0.0, 0.0, 0.0]])

        type_radii = {"X": 2.0}
        wrapper = ZenoWrapper(u.atoms, type_radii=type_radii, n_walks=5000, n_interior_samples=500)
        wrapper.run()
    ...
    def test_zero_radius_handling(self):
        ...
        u = make_Universe(extras=("radii", "types"), size=(3, 1, 1), n_frames=1)
    ...
    def test_reproducibility_with_seed(
        ...
        u = make_Universe(extras=("radii", "types"), size=(5, 1, 1), n_frames=1)
        ...
        wrapper1 = ZenoWrapper(u.atoms, type_radii=type_radii, n_walks=10000, n_interior_samples=1000, seed=42)
        wrapper1.run()

        wrapper2 = ZenoWrapper(u.atoms, type_radii=type_radii, n_walks=10000, n_interior_samples=1000, seed=42)
        wrapper2.run()
