...
The ZENOWrapper *Code of Conduct* sets the rules for the behavior of
every member in the ZENOWrapper community so that everyone can
...
ZENOWrapper is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make ZENOWrapper a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and ZENOWrapper is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of ZENOWrapper comes from its varied community
...
reported by contacting the project team at 'jennifer.clark@nist.gov'. The project team will
